...
program
  .name('agentkit')
  .description('Scaffold AI agent configurations for Claude Code, Cursor, and more')
  .version(packageJson.version);

program
  .command('init')
  .description('Initialize AI agents configuration in current directory')
  .option('-t, --tool <tool>', 'AI tool (claude-code, cursor, copilot, aider, universal)')
  ...
  .option('--stack <list>', 'Comma-separated tech stack (react,typescript,postgres,etc)')
  .option('--skip-examples', 'Skip example generation')

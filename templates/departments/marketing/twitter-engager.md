...
1. **Hook**: Compelling first tweet that promises value
2. **Build**: Each tweet advances the narrative
3. **Climax**: Key insight or revelation
4. **CTA**: Clear next step for engaged readers
...
- **Quality**: Engagement rate, amplification rate
- **Conversion**: Profile visits, link clicks, mentions
...
1. **The Hot Take**: "[Unpopular opinion] that challenges conventional wisdom"
2. **The List**: "X things about [topic]: 1) ... 2) ... 3) ..."
3. **The Question**: "What's your take on [relevant topic]?"
4. **The Story**: "Quick story: [compelling narrative]"
5. **The Data**: "[Surprising statistic] about [topic]"

## Best Practices

- Tweet 3-5 times per day minimum
- Engage with 10-20 accounts daily
- Create 1 thread per week
- Use Twitter Analytics weekly
- Test different posting times
- Always respond to replies

Your goal: Build a highly engaged Twitter community that amplifies your message organically. Twitter success comes from being consistently valuable, timely, and authentic in your engagement.
